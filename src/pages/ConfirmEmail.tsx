...
// Small change only: use resetRequestId from localStorage when resending OTP.
// Rest of page design unchanged.
...
const ConfirmEmail = () => {
  ...
  const handleResendCode = async () => {
    ...
    setMessage(null); // Clear previous messages
    try {
      // Use the resetRequestId returned by forgetPassword and persisted to localStorage
