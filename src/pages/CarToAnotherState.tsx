...
import lastPageForCarShipping from "@/assets/lastpageforcarshipping.png";
    ...
    <div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto flex flex-col md:flex-row gap-10 items-center px-6">
          <img
            src={lastPageForCarShipping}
            alt="Shipping containers"
            className="w-full md:w-1/2 rounded-xl shadow-lg object-cover"
          />
          <div className="md:w-1/2 space-y-5">
            <h2 className="text-3xl font-bold">What is Ship to Another State?</h2>
            <p className="text-gray-700 leading-relaxed">
              Our Ship to Another State car shipping service makes moving your vehicle from one state to another simple and reliable. We handle the entire process — picking up your car from your preferred location and delivering it safely to your chosen destination.
            </p>
            <p className="text-gray-700 leading-relaxed">
              You decide where your vehicle is picked up and dropped off. Whether it’s your home, office, or another convenient address, our driver will get as close as possible to both locations while following safety and legal regulations.
            </p>
            <p className="text-gray-700 leading-relaxed">
              In some areas, large transport trucks may be restricted due to narrow streets, low-hanging trees, or tight turns. In such cases, the driver will coordinate with you to meet at a nearby accessible spot, such as a large parking lot, for pickup or delivery.
            </p>
            <p className="text-gray-700 leading-relaxed">
              With this service, you avoid long drives, fuel expenses, and travel stress — while we ensure your vehicle arrives safely and on time across state lines.
            </p>
          </div>
        </div>
      </section>
